...
class ApiContext implements ApiClientAwareContext, ArrayContainsComparatorAwareContext, SnippetAcceptingContext {
    ...
    /**
     * Assert that the request body contains all keys / values in the parameter
     *
     * @param PyStringNode $contains
     * @throws AssertionFailedException
     * @return void
     ...
     */
    public function theRequestBodyContainsJson(PyStringNode $contains) {
        $this->requireRequest();
        ...
        // Get the decoded response body and make sure it's decoded to an array
        $body = json_decode((string) json_encode($this->getRequestBody()), true);
